...
var ve=Object.getPrototypeOf;var fe=Reflect.get;var lt=(e,t,s)=>fe(ve(e),s,t);import{a0 as h,a1 as Bt,a2 as L,a3 as k,a4 as he,a5 as j,a6 as Nt,a7 as A,a8 as $e,a9 as Rt,aa as x,ab as Ft,ac as be,ad as mt,ae as E,af as v,_ as ge,ag as Wt,ah as pt,ai as Et,aj as ye,ak as xe,al as _t,am as U,an as vt,ao as Ce,ap as Kt,aq as we,ar as O,as as Se,at as ke,au as Te,av as Qt,aw as rt,ax as De,ay as Ae,az as Me,aA as Pe,aB as Ie,aC as Ht}from"./app-CqP3DbKF.js";import{e as Oe,D as It,x as o,l as ft,o as Ve,c as Ge,t as Ot,A as Le,n as X,L as qt,i as Be}from"./vidstack-rsZGrNIW-BiUwPbUx.js";class Ne extends Ge{constructor(t){super(t),this.h=null,this.w=!1,this.$=null,this.w=t.type===Ot.ATTRIBUTE||t.type===Ot.BOOLEAN_ATTRIBUTE}render(t){return t!==this.h&&(this.disconnected(),this.h=t,this.isConnected&&this.Gl()),this.h?this.x(Nt(this.h)):Le}reconnected(){this.Gl()}disconnected(){var t;(t=this.$)==null||t.call(this),this.$=null}Gl(){this.h&&(this.$=A(this.l.bind(this)))}x(t){return this.w?ft(t):t}y(t){this.setValue(this.x(t))}l(){var t;this.y((t=this.h)==null?void 0:t.call(this))}}function i(e){return Oe(Ne)(h(e))}class zt{constructor(t,s){this._m=t,this.La=s,this.elements=new Set,this.Gc=Bt(this.Ha.bind(this))}connect(){this.Ha();const t=new MutationObserver(this.Gc);for(const s of this._m)t.observe(s,{childList:!0,subtree:!0});L(()=>t.disconnect()),L(this.disconnect.bind(this))}disconnect(){this.elements.clear()}assign(t,s){he(t)?(s.textContent="",s.append(t)):(It(null,s),It(t,s)),s.style.display||(s.style.display="contents");const n=s.firstElementChild;if(!n)return;const a=s.getAttribute("data-class");a&&n.classList.add(...a.split(" "))}Ha(t){if(t&&!t.some(a=>a.addedNodes.length))return;let s=!1,n=this._m.flatMap(a=>[...a.querySelectorAll("slot")]);for(const a of n)!a.hasAttribute("name")||this.elements.has(a)||(this.elements.add(a),s=!0);s&&this.La(this.elements)}}let Re=0,z="data-slot-id";class jt{constructor(t){this._m=t,this.Gc=Bt(this.Ha.bind(this)),this.slots=new zt(t,this.Ha.bind(this))}connect(){this.slots.connect(),this.Ha();const t=new MutationObserver(this.Gc);for(const s of this._m)t.observe(s,{childList:!0});L(()=>t.disconnect())}Ha(){for(const t of this._m)for(const s of t.children){if(s.nodeType!==1)continue;const n=s.getAttribute("slot");if(!n)continue;s.style.display="none";let a=s.getAttribute(z);a||s.setAttribute(z,a=++Re+"");for(const l of this.slots.elements){if(l.getAttribute("name")!==n||l.getAttribute(z)===a)continue;const r=document.importNode(s,!0);n.includes("-icon")&&r.classList.add("vds-icon"),r.style.display="",r.removeAttribute("slot"),this.slots.assign(r,l),l.setAttribute(z,a)}}}}function Fe({name:e,class:t,state:s,paths:n,viewBox:a="0 0 32 32"}){return o`<svg
  ...
  `}function Yt({tooltip:e}){const{translations:t}=u(),{remotePlaybackState:s}=v(),n=i(()=>{const l=w(t,"Google Cast"),r=Et(s());return`${l} ${r}`}),a=d(t,"Google Cast");return o`
  ...
  `}function Vt({tooltip:e,ref:t=we}){const{translations:s}=u(),n=d(s,"Mute"),a=d(s,"Unmute");return o`
  ...
  `}function N({label:e,icon:t,hint:s}){return o`
  ...
  `}const wt={type:"color"},Ue={type:"radio",values:{"Monospaced Serif":"mono-serif","Proportional Serif":"pro-serif","Monospaced Sans-Serif":"mono-sans","Proportional Sans-Serif":"pro-sans",Casual:"casual",Cursive:"cursive","Small Capitals":"capitals"}},Ze={type:"slider",min:0,max:400,step:25,upIcon:"menu-font-size-up",downIcon:"menu-font-size-down"},St={type:"slider",min:0,max:100,step:5,upIcon:"menu-opacity-up",downIcon:"menu-opacity-down"},Ye={type:"radio",values:["None","Drop Shadow","Raised","Depressed","Outline"]},kt=Wt();function Xe(){return i(()=>{const{hasCaptions:e}=v(),{translations:t}=u();return e()?(Rt(kt,{all:new Set}),o`
    ...
    `):null})}function Je(){return P({group:"font",label:"Family",option:Ue,defaultValue:"pro-sans",cssVarName:"font-family",getCssVarValue(e,t){var n;const s=e==="capitals"?"small-caps":"";return(n=t.el)==null||n.style.setProperty("--media-user-font-variant",s),us(e)}})}function ts(){return P({group:"font",label:"Size",option:Ze,defaultValue:"100%",cssVarName:"font-size",getCssVarValue:nt})}function es(){return P({group:"text",label:"Color",option:wt,defaultValue:"#ffffff",cssVarName:"text-color",getCssVarValue(e){return`rgb(${Ct(e)} / var(--media-user-text-opacity, 1))`}})}function ss(){return P({group:"text",label:"Opacity",option:St,defaultValue:"100%",cssVarName:"text-opacity",getCssVarValue:nt})}function ns(){return P({group:"text",label:"Shadow",option:Ye,defaultValue:"none",cssVarName:"text-shadow",getCssVarValue:ds})}function as(){return P({group:"text-bg",label:"Color",option:wt,defaultValue:"#000000",cssVarName:"text-bg",getCssVarValue(e){return`rgb(${Ct(e)} / var(--media-user-text-bg-opacity, 1))`}})}function is(){return P({group:"text-bg",label:"Opacity",option:St,defaultValue:"100%",cssVarName:"text-bg-opacity",getCssVarValue:nt})}function os(){return P({group:"display",label:"Color",option:wt,defaultValue:"#000000",cssVarName:"display-bg",getCssVarValue(e){return`rgb(${Ct(e)} / var(--media-user-display-bg-opacity, 1))`}})}function ls(){return P({group:"display",label:"Opacity",option:St,defaultValue:"0%",cssVarName:"display-bg-opacity",getCssVarValue:nt})}function rs(){const{translations:e}=u(),t=()=>w(e,"Reset"),s=pt(kt);function n(){s.all.forEach(a=>a())}return o`
    <button class="vds-menu-item" role="menuitem" @click=${n}>
      <span class="vds-menu-item-label">${i(t)}</span>
    </button>
  `}function P({group:e,label:t,option:s,defaultValue:n,cssVarName:a,getCssVarValue:l}){const{player:r}=k(),{translations:p}=u(),c=pt(kt),$=`${e}-${t.toLowerCase()}`,f=x(n),m=()=>w(p,t),b=localStorage.getItem(`vds-player:${$}`);b&&g(b);function g(C){var S;f.set(C),localStorage.setItem(`vds-player:${$}`,C),(S=r.el)==null||S.style.setProperty(`--media-user-${a}`,(l==null?void 0:l(C,r))??C)}c.all.add(y),L(()=>void c.all.delete(y));function y(){g(n),I()}function I(){r.dispatchEvent(new Event("vds-font-change"))}if(s.type==="color"){let C=function(S){g(S.target.value),I()};return Q({label:i(m),children:o`
        <input
          ...
          @input=${C}
        />
      `})}if(s.type==="slider"){let C=function(q){g(q.detail+"%"),I()};const{min:S,max:V,step:F,upIcon:H,downIcon:W}=s;return st({label:i(m),value:i(f),upIcon:H,downIcon:W,isMin:()=>f()===S+"%",isMax:()=>f()===V+"%",children:o`
        <media-slider
          class="vds-slider"
          min=${S}
          max=${V}
      ...
      `})}const R=je(s.values),ot=()=>{var V;const C=f(),S=((V=R.find(F=>F.value===C))==null?void 0:V.label)||"";return w(p,j(S)?S:S())};return o`
  ...
  `}function nt(e){return(parseInt(e)/100).toString()}function us(e){switch(e){case"mono-serif":return'"Courier New", Courier, "Nimbus Mono L", "Cutive Mono", monospace';case"mono-sans":return'"Deja Vu Sans Mono", "Lucida Console", Monaco, Consolas, "PT Mono", monospace';case"pro-sans":return'Roboto, "Arial Unicode Ms", Arial, Helvetica, Verdana, "PT Sans Caption", sans-serif';case"casual":return'"Comic Sans MS", Impact, Handlee, fantasy';case"cursive":return'"Monotype Corsiva", "URW Chancery L", "Apple Chancery", "Dancing Script", cursive';case"capitals":return'"Arial Unicode Ms", Arial, Helvetica, Verdana, "Marcellus SC", sans-serif + font-variant=small-caps';default:return'"Times New Roman", Times, Georgia, Cambria, "PT Serif Caption", serif'}}function ds(e){switch(e){case"drop shadow":return"rgb(34, 34, 34) 1.86389px 1.86389px 2.79583px, rgb(34, 34, 34) 1.86389px 1.86389px 3.72778px, rgb(34, 34, 34) 1.86389px 1.86389px 4.65972px";case"raised":return"rgb(34, 34, 34) 1px 1px, rgb(34, 34, 34) 2px 2px";case"depressed":return"rgb(204, 204, 204) 1px 1px, rgb(34, 34, 34) -1px -1px";case"outline":return"rgb(34, 34, 34) 0px 0px 1.86389px, rgb(34, 34, 34) 0px 0px 1.86389px, rgb(34, 34, 34) 0px 0px 1.86389px, rgb(34, 34, 34) 0px 0px 1.86389px, rgb(34, 34, 34) 0px 0px 1.86389px";default:return""}}function at({label:e,checked:t,defaultChecked:s=!1,storageKey:n,onChange:a}){const{translations:l}=u(),r=n?localStorage.getItem(n):null,p=x(!!(r??s)),c=x(!1),$=i(ke(p)),f=d(l,e);n&&a(Nt(p)),t&&A(()=>void p.set(t()));function m(y){(y==null?void 0:y.button)!==1&&(p.set(I=>!I),n&&localStorage.setItem(n,p()?"1":""),a(p(),y),c.set(!1))}function b(y){Te(y)&&m()}function g(y){y.button===0&&c.set(!0)}return o`
    <div
  ...
  `}function cs(){return i(()=>{const{translations:e}=u();return o`
      <media-menu class="vds-accessibility-menu vds-menu">
        ${N({label:()=>w(e,"Accessibility"),icon:"menu-accessibility"})}
        <media-menu-items class="vds-menu-items">
    ...
    `})}function ms(){const{userPrefersAnnouncements:e,translations:t}=u(),s="Announcements";return Q({label:d(t,s),children:at({label:s,storageKey:"vds-player::announcements",onChange(n){e.set(n)}})})}function ps(){return i(()=>{const{translations:e,userPrefersKeyboardAnimations:t,noKeyboardAnimations:s}=u(),{viewType:n}=v();if(h(()=>n()!=="video"||s())())return null;const l="Keyboard Animations";return Q({label:d(e,l),children:at({label:l,defaultChecked:!0,storageKey:"vds-player::keyboard-animations",onChange(r){t.set(r)}})})})}function vs(){return i(()=>{const{noAudioGain:e,translations:t}=u(),{audioTracks:s,canSetAudioGain:n}=v();return h(()=>!(n()&&!e())&&s().length<=1)()?null:o`
      <media-menu class="vds-audio-menu vds-menu">
        ${N({label:()=>w(t,"Audio"),icon:"menu-audio"})}
        <media-menu-items class="vds-menu-items">
          ${[fs(),hs()]}
        </media-menu-items>
      </media-menu>
  ...
  `}function ne(){const{audioGains:e}=u(),t=e();return O(t)?t[0]??0:t.min}function ae(){const{audioGains:e}=u(),t=e();return O(t)?t[t.length-1]??300:t.max}function bs(){const{audioGains:e}=u(),t=e();return O(t)?t[1]-t[0]||25:t.step}function gs(){return i(()=>{const{translations:e}=u(),{hasCaptions:t}=v(),s=d(e,"Off");return t()?o`
      <media-menu class="vds-captions-menu vds-menu">
        ${N({label:()=>w(e,"Captions"),icon:"menu-captions"})}
        <media-menu-items class="vds-menu-items">
    ...
    `:null})}function ys(){return i(()=>{const{translations:e}=u();return o`
      <media-menu class="vds-playback-menu vds-menu">
        ${N({label:()=>w(e,"Playback"),icon:"menu-playback"})}
        <media-menu-items class="vds-menu-items">
          ${[D({children:xs()}),Cs(),Ts()]}
        </media-menu-items>
      </media-menu>
    `})}function xs(){const{remote:e}=k(),{translations:t}=u(),s="Loop";return Q({label:d(t,s),children:at({label:s,storageKey:"vds-player::user-loop",onChange(n,a){e.userPrefersLoopChange(n,a)}})})}function Cs(){return i(()=>{const{translations:e}=u(),{canSetPlaybackRate:t,playbackRate:s}=v();return t()?D({label:d(e,"Speed"),value:i(()=>s()===1?w(e,"Normal"):s()+"x"),children:[st({upIcon:"menu-speed-up",downIcon:"menu-speed-down",children:Ss(),isMin:()=>s()===ie(),isMax:()=>s()===oe()})]}):null})}function ie(){const{playbackRates:e}=u(),t=e();return O(t)?t[0]??0:t.min}function oe(){const{playbackRates:e}=u(),t=e();return O(t)?t[t.length-1]??2:t.max}function ws(){const{playbackRates:e}=u(),t=e();return O(t)?t[1]-t[0]||.25:t.step}function Ss(){const{translations:e}=u(),t=d(e,"Speed"),s=ie,n=oe,a=ws;return o`
    <media-speed-slider
  ...
  `}function Ps(){return i(()=>{const{live:e,duration:t}=v();return e()?Jt():t()?o`<media-time class="vds-time" type="current" toggle remainder></media-time>`:null})}function re(){return i(()=>{const{live:e}=v();return e()?Jt():Ms()})}function ue(){return i(()=>{const{textTracks:e}=k(),{title:t,started:s}=v(),n=x(null);return _t(e,"chapters",n.set),n()&&(s()||!t())?de():o`<media-title class="vds-chapter-title"></media-title>`})}function de(){return o`<media-chapter-title class="vds-chapter-title"></media-chapter-title>`}class ce extends Ee{async Pf(){const t=(await ge(()=>import("./vidstack-CRlTZX3Z-PBDNdscv.js"),__vite__mapDeps([0,1]))).icons,s={};for(const n of Object.keys(t))s[n]=Fe({name:n,paths:t[n]});return s}}var G;let Is=(G=class extends B{},G.props={...lt(G,G,"props"),when:({viewType:t})=>t==="audio",smallWhen:({width:t})=>t<576},G);function Os(){return[$t(),xt(),o`
    ...
    `]}function Vs(){return i(()=>{let e=x(void 0),t=x(!1),s=k(),{title:n,started:a,currentTime:l,ended:r}=v(),{translations:p}=u(),c=Ae(e),$=()=>a()||l()>0;const f=()=>{const g=r()?"Replay":$()?"Continue":"Play";return`${w(p,g)}: ${n()}`};A(()=>{var g;c()&&document.activeElement===document.body&&((g=s.player.el)==null||g.focus())});function m(){const g=e(),y=!!g&&!c()&&g.clientWidth<g.children[0].clientWidth;g&&Me(g,"vds-marquee",y),t.set(y)}function b(){return o`
    ...
    `})}function Ls(){var n;const{$state:e}=k(),t=(n=e.lastKeyboardAction())==null?void 0:n.action,s=e.audioGain()??1;switch(t){case"toggleMuted":return e.muted()?"0%":Lt(e.volume(),s);case"volumeUp":case"volumeDown":return Lt(e.volume(),s);default:return""}}function Lt(e,t){return`${Math.round(e*t*100)}%`}function Bs(){var s;const{$state:e}=k();switch((s=e.lastKeyboardAction())==null?void 0:s.action){case"togglePaused":return e.paused()?"kb-pause-icon":"kb-play-icon";case"toggleMuted":return e.muted()||e.volume()===0?"kb-mute-icon":e.volume()>=.5?"kb-volume-up-icon":"kb-volume-down-icon";case"toggleFullscreen":return`kb-fs-${e.fullscreen()?"enter":"exit"}-icon`;case"togglePictureInPicture":return`kb-pip-${e.pictureInPicture()?"enter":"exit"}-icon`;case"toggleCaptions":return e.hasCaptions()?`kb-cc-${e.textTrack()?"on":"off"}-icon`:null;case"volumeUp":return"kb-volume-up-icon";case"volumeDown":return"kb-volume-down-icon";case"seekForward":return"kb-seek-forward-icon";case"seekBackward":return"kb-seek-backward-icon";default:return null}}function Ns(){return[$t(),pe(),it(),me(),xt(),o`<div class="vds-scrim"></div>`,o`
      <media-controls class="vds-controls">
