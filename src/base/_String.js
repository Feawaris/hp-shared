 ...
 * @returns {string}
 */
export function toFirstUpperCase(name = '') {
 ...
 * @returns {string}
 */
export function toFirstLowerCase(name = '') {
 ...
 */
export function toCamelCase(name, { separator = '-', first = 'raw' } = {}) {
  // 生成正则
 ...
 * @returns {string}
 */
export function toLineCase(name = '', { separator = '-' } = {}) {
  return name
    // 按连接符拼接
